...
public class ACMNumbering extends OOXMLNumbering {
	...
	public static void generateCaptionNumbering(NumberingDefinitionsPart numberingDefinitionsPart, boolean isTable){
		try {
			...
			AbstractNum abstractNumTemp = isTable?
					AppEnvironment.getInstance().getStylePool().getStyles().get(AcademicFormatStructureDefinition.ACM).getNumberingMap().get(AcademicFormatStructureDefinition.NUMBERINGCAPTIONSTRING)
					:AppEnvironment.getInstance().getStylePool().getStyles().get(AcademicFormatStructureDefinition.ACM).getNumberingMap().get(AcademicFormatStructureDefinition.NUMBERINGFIGURESTRING);
			Map<String, Style> stylemap = AppEnvironment.getInstance().getStylePool().getStyles().get(AcademicFormatStructureDefinition.ACM).getStyleMap();
			...
			MultiLevelType lvlType = wmlObjectFactory.createNumberingAbstractNumMultiLevelType();
			...
			if(isDoAppend){
				Num appendNum = wmlObjectFactory.createNumberingNum();
				appendNum.setNumId(abstractNumTemp.getAbstractNumId());
				AbstractNumId numId = wmlObjectFactory.createNumberingNumAbstractNumId();
	...
	public static void generateReferenceNumbering(NumberingDefinitionsPart numberingDefinitionsPart){
		try {
			 ...
			 * vAlign)
			 */
//			createLvl(abstractNum, "0", NumberFormat.DECIMAL, styleName, "[%1]", true, "360", "0", JcEnumeration.LEFT, 
//					STTabJc.NUM, "360", null, "0", "360", null, null, STHint.DEFAULT, 
//					false, false, false, false, false, false,
//					"000000", "24", "24", STVerticalAlignRun.BASELINE);
	...
	public static void generateSectionHeaderNumbering(NumberingDefinitionsPart numberingDefinitionsPart){
		try {
			...
			AbstractNum abstractNumTemp = AppEnvironment.getInstance().getStylePool().getStyles().get(AcademicFormatStructureDefinition.ACM).getNumberingMap().get(AcademicFormatStructureDefinition.NUMBERINGSECTIONSTRING);
			Map<String, Style> stylemap = AppEnvironment.getInstance().getStylePool().getStyles().get(AcademicFormatStructureDefinition.ACM).getStyleMap();
				...
				if(lvl.getIlvl()!=null){
					...
					case 2:
						createLvl(abstractNum, "2", lvl.getNumFmt().getVal(), AcademicFormatStructureDefinition.HEADING3, 
								...
								false, false, false,
								"auto", 
								stylemap.get(AcademicFormatStructureDefinition.HEADING3).getRPr().getSz()!=null?stylemap.get(AcademicFormatStructureDefinition.HEADING3).getRPr().getSz().getVal().toString():"22", 
								stylemap.get(AcademicFormatStructureDefinition.HEADING3).getRPr().getSz()!=null?stylemap.get(AcademicFormatStructureDefinition.HEADING3).getRPr().getSz().getVal().toString():"22", 
								STVerticalAlignRun.BASELINE);
						break;
					case 3:
						createLvl(abstractNum, "3", lvl.getNumFmt().getVal(), AcademicFormatStructureDefinition.HEADING4, 
								...
								false, false, false,
								"auto", 
								stylemap.get(AcademicFormatStructureDefinition.HEADING4).getRPr().getSz()!=null?stylemap.get(AcademicFormatStructureDefinition.HEADING4).getRPr().getSz().getVal().toString():"22", 
								stylemap.get(AcademicFormatStructureDefinition.HEADING4).getRPr().getSz()!=null?stylemap.get(AcademicFormatStructureDefinition.HEADING4).getRPr().getSz().getVal().toString():"22", 
								STVerticalAlignRun.BASELINE);
						break;
					case 4:
...
//								"auto", "20", "20", STVerticalAlignRun.BASELINE);
			...
			createLvl(abstractNum, "2", NumberFormat.DECIMAL, head3, "%1.%2.%3", true, "144", "0", JcEnumeration.LEFT, 
					...
					"000000", "22", "22", STVerticalAlignRun.BASELINE);
			...
			createLvl(abstractNum, "4", NumberFormat.DECIMAL, head5, "%1.%2.%3.%4.%5", true, "144", "0", JcEnumeration.LEFT, 
					null, null, null, null, null, null, null, STHint.DEFAULT, 
					false, true, false, false, false, false,
					"auto", "22", "22", STVerticalAlignRun.BASELINE);
			*/
			if(isDoAppend){
				Num appendNum = new Num();
				appendNum.setNumId(abstractNum.getAbstractNumId());
