...
public class OOXMLElsevierStyle2 implements AbstractPublishingStyle {
	...
	public OOXMLElsevierStyle2() {
		...
		style.getPPr().getSpacing().setAfter(new BigInteger("340"));
		style.getPPr().getSpacing().setLine(new BigInteger("440"));
		style.getPPr().getSpacing().setLineRule(STLineSpacingRule.EXACT);
		style.getPPr().setJc(new Jc());
		style.getPPr().getJc().setVal(JcEnumeration.BOTH);
		...
		style.getRPr().getRFonts().setAscii("Times New Roman");	// Times New Roman
		style.getRPr().setSz(new HpsMeasure());
		style.getRPr().getSz().setVal(new BigInteger("32"));// 16-points
		...
		style.setPPr(new PPr());
		style.getPPr().setSpacing(new Spacing());
		style.getPPr().getSpacing().setAfter(new BigInteger("180"));
