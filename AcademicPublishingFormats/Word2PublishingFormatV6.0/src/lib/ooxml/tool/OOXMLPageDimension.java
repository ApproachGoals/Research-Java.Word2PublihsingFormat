...
public class OOXMLPageDimension {
//	protected static Logger log = LoggerFactory.getLogger(OOXMLPageDimension.class.getName());


	public OOXMLPageDimension() {
	 ...
	 * @since 2.7
	 */
	public OOXMLPageDimension(PgSz pgSz, PgMar pgMar) {
	 ...
	 * @since 2.7
	 */
	public OOXMLPageDimension(SectPr sectPr) {
		if (sectPr==null) {
			init(null, null, null);
		} else {
